...
*/
  ...
  componentDidMount(){
    return fetch('http://'+IP.ipcim+'/termekek')
  ...
  render(){
    ...
    return(
      ...
      <View elevation={5} style={styles.container}>
          ...
          <Image  source={{uri:'http://'+IP.ipcim+'/'+item.kep_id}}   style={{ width:225, height:314 ,marginLeft:"auto",marginRight:"auto", borderRadius:10}} />  
